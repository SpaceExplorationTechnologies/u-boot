 ...
 *    sxra3 c-header st-register-ipxact/CatsonD_computing_platform_registers_without_sxips_rev1b_amykyta_modified.xml -o backbone_syscfg_000_799.h --namespace CatsonV4Registers --subset catson_4.BACKBONE_SYSCFG_000_799
 * -----------------------------------------------------------------------------
 */
#ifndef BACKBONE_SYSCFG_000_799_H
#define BACKBONE_SYSCFG_000_799_H
...
/*
 * Register: SYSTEM_CONFIG601
 *   Offset is absolute
 */
#define SYSTEM_CONFIG601_REG_OFFSET    0x00132004u

#define SYSTEM_CONFIG601__SYSNOTRESETOUT_LENGTH_bp    0u
#define SYSTEM_CONFIG601__SYSNOTRESETOUT_LENGTH_bm    0xFFFFFFFFu
#define SYSTEM_CONFIG601__SYSNOTRESETOUT_LENGTH_bc    32u

/*
 * Register: SYSTEM_CONFIG602
 *   Offset is absolute
 */
#define SYSTEM_CONFIG602_REG_OFFSET    0x00132008u

#define SYSTEM_CONFIG602__SYS_NOTRESETOUT_UPDATE_bp    0u
#define SYSTEM_CONFIG602__SYS_NOTRESETOUT_UPDATE_bm    0x00000001u
#define SYSTEM_CONFIG602__SYS_NOTRESETOUT_UPDATE_bc    1u
...
typedef struct {
    ...
    uint32_t SYSTEM_CONFIG601;
    uint32_t SYSTEM_CONFIG602;
    uint8_t reserved_0x13200c_0x1effff[0xbdff4];
...
#endif /* BACKBONE_SYSCFG_000_799_H */
