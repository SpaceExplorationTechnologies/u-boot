 ...
 *    sxra c_header --namespace CatsonVersion1Registers -o modem_adc_if.h ../../catson_registers_secure_without_sxips_ASSY4.6_modified_amykyta.xml --set-top MAP_CATSON.MODEM_ADC_IF_SYSCFG_ADC_INTERFACE
 * -----------------------------------------------------------------------------
 */
#ifndef MODEM_ADC_IF__H
#define MODEM_ADC_IF__H
...
typedef struct {
    ...
    uint8_t reserved_0xd4_0xfffff[0xfff2c];
