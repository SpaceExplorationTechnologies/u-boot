...
no-dot-config-targets := clean clobber mrproper distclean \
			 ...
			 ubootversion backup tests check qcheck tools-only
...
ALL-$(CONFIG_RAMBOOT_PBL_WITH_DEFAULT_ENV) += u-boot.env.pbl
endif
endif
...
u-boot.env.pbl: u-boot.bin u-boot.pbl u-boot.map
	$(srctree)/tools/pad_with_default_env.py $^ $@
